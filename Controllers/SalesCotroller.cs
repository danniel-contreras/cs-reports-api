...
public class SalesController : ControllerBase
{
    ...
    public FileContentResult GeneratePDF([FromBody] SalesReportI body)
    {
        ...
        htmlcontent += "<style>";
        htmlcontent += "html { -webkit-print-color-adjust: exact;style='page-break-after:always;' }";
        htmlcontent += "</style>";
        htmlcontent += "</head>";
        ...
        htmlcontent += "<tr style='background-color:#092E60'>";
        htmlcontent += "<th style='color:#000;padding:5px;background-color:#092E60;'>No.</th>";
        htmlcontent += "<th style='color:#000;padding:5px;background-color:#092E60;'>No. Ticket</th>";
        htmlcontent += "<th style='color:#000;padding:5px;background-color:#092E60;'>Sucursal</th>";
        htmlcontent += "<th style='color:#000;padding:5px;background-color:#092E60;'>Fecha</th>";
        htmlcontent += "<th style='color:#000;padding:5px;background-color:#092E60;'>Total</th>";
        htmlcontent += "</tr>";
        htmlcontent += "</thead>";
        htmlcontent += "</table>";
        htmlcontent += "</div>";
